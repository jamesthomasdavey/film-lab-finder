...
// @desc    gets the main page of the lab
// @access  public
...
// @access  private
router.get('/labs/:labId/settings', requireSignin, isLabOwner, (req, res) => {
...
// @desc    find the lab and retrieve its name and description settings
// @access  private
router.put('/labs/:labId/settings', requireSignin, isLabOwner, (req, res) => {
  // todo: make sure that user is lab owner
  const errors = {
    name: [],
    description: [],
      ...
      return res.json({
        ...
        scanners: {
          defaultScanner: {
            ...
            desc: {
              value:
                foundLab.settings.scanSettings.scanners.defaultScanner.desc,
...
// @access  private
router.get(
  '/labs/:labId/settings/service-pricing',
  requireSignin,
  isLabOwner,
  (req, res) => {
    // todo: make sure that user is lab owner
          ...
          if (labCanSupport && foundLabService.isEnabled) {
            ...
            rows.push({
              ...
              receiveMounted: {
                ...
                isEnabled:
                  foundLabService.addOns.hasE6AndHasScanAndSansDev
                    .receiveMounted.isEnabled,
              ...
              returnSleeved: {
                ...
                isEnabled:
                  foundLabService.addOns.hasScanOrHasDev.returnSleeved
                    .isEnabled,
                ...
                additionalResolutions: foundLabService.addOns.hasScan.defaultScanner.additionalResolutions.map(
                  (additionalResolution, i) => {
                    return {
                      isAllowed:
                        hasScan &&
                        columns.defaultScanner.additionalResolutions[i]
                          .isAllowed,
...
// @access  private
router.get(
  '/labs/:labId/settings/service-pricing/edit',
  requireSignin,
  isLabOwner,
  (req, res) => {
    Lab.findById(req.params.labId)
